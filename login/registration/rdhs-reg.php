...
<div id="main" style="width:1150px">
	<div id="header">
		...
		<hr class="noscreen"/>
		<div id="nav"> 
			<img width="630px" src="images/tmp/heading.png" alt="" />
    ...
    <div id="col"class="box" style="height:1500px; overflow:hidden">         
		<div name="mainpannel"  style="height:1500px; width:100%">         
		<iframe style="width:100%; height:95%; margin-top:-30px;" src="rdhsReg.php"></iframe>
		</div>
		<div id="col-text"></div>
	</div>
	<hr class="noscreen" />
